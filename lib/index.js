...
module.exports = ReactCoffeeCompiler = (function() {
  ...
  function ReactCoffeeCompiler(config) {
    ...
    this.config = config;
    this.includeHeader = ((_ref = this.config) != null ? (_ref1 = _ref.plugins) != null ? (_ref2 = _ref1.reactCoffee) != null ? _ref2.autoIncludeCommentBlock : void 0 : void 0 : void 0) === true;
  }

  ReactCoffeeCompiler.prototype.compile = function(params, callback) {
    var err, source, transformed;
